...
// void
// fat_create (void) { //! free_map_create
// 	// Create FAT boot
// 	fat_boot_create ();
// 	fat_fs_init ();
...
// 	for (clst; fat_get(clst) != EOChain; clst = fat_get(clst)){
// 	// printf ("33333333333333333333333\n");
// 	;
// 	}
// 	// printf ("44444444444444444444444\n");
		
// 	// for (clst; fat_fs->fat[clst] != EOChain; clst = fat_fs->fat[clst])
// 	// 	;
...
// // 	/* TODO: Your code goes here. */
// // 	return (cluster_t) sector - fat_fs->data_start;
// // }
// // // TODO END
